...
features = dict(
    mir=[
        ...
        'nrg', 'nrg_std',
        'pow', 'pow_std',
        'acr', 'acr_std', 'acr_lag', 'acr_lag_std',
        'cent', 'cent_std',
        'flx', 'flx_std',
        'rlf', 'rlf_std',
        'mfcc_0', 'mfcc_0_std',
    ...
    metadata_artist=[
        'is_male', 'is_female', 'is_group',
        'german', 'american', 'other_country',
        'total_years', 'life_span',
        'artist_genre_electronic', 'artist_genre_pop', 'artist_genre_hiphop', 'artist_genre_rock',
        'artist_genre_other',
        'followers', 'listener', 'play_count', 'popularity',
        'mean_chart_peak_0', 'mean_chart_peak_1', 'mean_chart_peak_2', 'mean_chart_peak_3', 'mean_chart_peak_4',
        'mean_chart_peak_5', 'mean_chart_peak_6',
        'mean_chart_weeks', 'total_chart_weeks',
        'mean_album_chart_peak_0', 'mean_album_chart_peak_1', 'mean_album_chart_peak_2', 'mean_album_chart_peak_3',
        'mean_album_chart_peak_4', 'mean_album_chart_peak_5', 'mean_album_chart_peak_6',
    ...
    metadata_track=[
        ...
        'is_1980s', 'is_1990s', 'is_2000s', 'is_2010s', 'is_other_decade',
        'length'
    ]
)
